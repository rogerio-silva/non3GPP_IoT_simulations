...
#ifndef NOADR_COMPONENT_H
#define NOADR_COMPONENT_H
...
class NoAdrComponent : public NetworkControllerComponent
{
...
public:
  ...
  void OnFailedReply (Ptr<EndDeviceStatus> status,
                      Ptr<NetworkStatus> networkStatus);
private:
  void NoAdrImplementation (uint8_t *newDataRate,
                          uint8_t *newTxPower,
                          Ptr<EndDeviceStatus> status);
