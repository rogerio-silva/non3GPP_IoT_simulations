...
main (int argc, char *argv[])
{
  ...
  ************************/
  ...
  EndDevicesPlacement (".datafile/devices/placement/endDevices_LNM_Placement_" +
  ...
  *********************/
  ...
  std::string filename = "./datafile/density-oriented/placement/"
  ...
  if (printRates)
    {
      ...
      std::string phyPerformanceFile = "./datafile/density-oriented/"
      ...
      std::string phyPerfPerGatewayFile = "./datafile/density-oriented/"
